...
| Quartz forms | Prism m {10-10}, positive rhombohedron r {10-11}, negative rhombohedron z {01-11} defined in [quartz.json](../packages/crystal-data/src/minerals/quartz.json) using Miller-Bravais notation. All forms pass through the generic `generateCrystal` contract. |
